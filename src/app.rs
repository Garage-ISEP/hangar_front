        ...
        (
            ...
            r#"{
                ...
                "create_project": {
                    ...
                    "deployment_stage_started": "Starting",
                    "deployment_stage_validating": "Validating",
                    "deployment_stage_pulling": "Pulling image",
                    "deployment_stage_pulled": "Image pulled",
                    "deployment_stage_scanning": "Scanning",
                    "deployment_stage_scanned": "Scan complete",
                    "deployment_stage_cloning": "Cloning repository",
                    "deployment_stage_cloned": "Repository cloned",
                    "deployment_stage_building": "Building image",
                    "deployment_stage_built": "Image built",
                    "deployment_stage_digest": "Getting digest",
                    "deployment_stage_creating": "Creating container",
                    "deployment_stage_created": "Container created",
                    "deployment_stage_health": "Health check",
                    "deployment_stage_healthy": "Health check passed",
                    "deployment_stage_db_provision": "Provisioning database",
                    "deployment_stage_db_provisioned": "Database ready",
                    "deployment_stage_db_linking": "Linking database",
                    "deployment_stage_db_linked": "Database linked",
                    "deployment_stage_cleanup": "Cleaning up",
                    "deployment_stage_completed": "Deployment complete",
                    "deployment_stage_failed": "Deployment failed",
                    "deployment_redirecting": "Redirecting to dashboard..."
                },
                "project_dashboard": {
                    ...
                    "deployment_starting": "Deployment starting...",
                    "deployment_updating": "Update in progress",
                    "deployment_complete": "Update completed successfully!"
                },
                "database": {
                    "title": "Database",
        ...
        (
            ...
            r#"{
                ...
                "create_project": {
                    ...
                    "deployment_stage_started": "Démarrage",
                    "deployment_stage_validating": "Validation",
                    "deployment_stage_pulling": "Téléchargement",
                    "deployment_stage_pulled": "Image téléchargée",
                    "deployment_stage_scanning": "Scan sécurité",
                    "deployment_stage_scanned": "Scan terminé",
                    "deployment_stage_cloning": "Clonage dépôt",
                    "deployment_stage_cloned": "Dépôt cloné",
                    "deployment_stage_building": "Construction",
                    "deployment_stage_built": "Image construite",
                    "deployment_stage_digest": "Récupération digest",
                    "deployment_stage_creating": "Création conteneur",
                    "deployment_stage_created": "Conteneur créé",
                    "deployment_stage_health": "Vérification santé",
                    "deployment_stage_healthy": "Vérification réussie",
                    "deployment_stage_db_provision": "Création BDD",
                    "deployment_stage_db_provisioned": "BDD prête",
                    "deployment_stage_db_linking": "Liaison BDD",
                    "deployment_stage_db_linked": "BDD liée",
                    "deployment_stage_cleanup": "Nettoyage",
                    "deployment_stage_completed": "Déploiement terminé",
                    "deployment_stage_failed": "Échec du déploiement",
                    "deployment_redirecting": "Redirection..."
                },
                "project_dashboard": {
                    ...
                    "deployment_starting": "Déploiement en cours de démarrage...",
                    "deployment_updating": "Mise à jour en cours",
                    "deployment_complete": "Mise à jour terminée avec succès !"
                },
                "database": {
